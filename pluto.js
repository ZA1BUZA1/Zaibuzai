...
if(cluster.isMaster){
	for(let counter=1;counter<=args.threads;counter++){
		cluster.fork();
    console.log('\x1b[38;2;255;0;0m________                                                _________')
    console.log('\x1b[38;2;255;0;0m\________\--------___       ___         ____----------/_________/')
    console.log('\x1b[38;2;255;0;0m    \_______\----\\\\\\   //_ _ \\    //////-------/________/')
    console.log('\x1b[38;2;255;0;0m        \______\----\\|| (( ~|~ )))  ||//------/________/')
    console.log('\x1b[38;2;255;0;0m            \_____\---\\ ((\ = / ))) //----/_____/')
    console.log('\x1b[38;2;255;0;0m                 \____\--\_)))  \ _)))---/____/')
    console.log('\x1b[38;2;255;0;0m                       \__/ (((    (((_/')
    console.log('\x1b[38;2;255;0;0mF0CK3T                 |  -)))  -  ))')
	}
}else{
