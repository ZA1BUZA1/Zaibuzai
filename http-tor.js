...
const tips1 =[
 ...
 if (cluster.isMaster) {
    console.clear()
    console.log(`--------------------------------------------`.gray)
    console.log(`Target: `.brightBlue + process.argv[2])
    console.log(`Time: `.brightBlue + process.argv[3])
    console.log(`Rate: `.brightBlue + process.argv[4])
    console.log(`Thread: `.brightBlue + process.argv[5])
    console.log(`ProxyFile: `.brightBlue + process.argv[6])
    console.log(`--------------------------------------------`.gray)
